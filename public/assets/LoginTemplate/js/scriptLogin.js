...
$(function(){
    ...
    $("#login").click(function(e){
		...
		console.log($("#passLog").val());
		

        /*** check Required fields *****/
        if($("#emailLog").val() == ""){
            e.preventDefault();
            swal("Ooops!","Votre E-mail est obligatoire!","warning");
			//showValidate($("#emailLog"));
            check = false;
        }else if(validateEmail($("#emailLog").val()) == false){
            e.preventDefault();
            //showValidate($("#emailLog"));
            swal("Ooops!","Adresse E-mail incorrecte!","warning");
        ...
        if($("#passLog").val() == ""){
			...
			swal("Ooops!","Mot de passe est obligatoire!","warning");
            check = false;
        }
