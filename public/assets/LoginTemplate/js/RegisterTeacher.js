    ...
    $('#registerFormTeacher').on('submit',function(e){
        ...
        for(var i=0; i<input.length; i++) {
            ...
            if($("#pass").val() == "" ){
                ...
                //showValidate($("#pass"));
                //$("#pass").parent().attr("data-validate","Mot de passe est obligatoire")
                swal("Oops!", "Mot de passe est obligatoire", "warning");
                check=false;
            }else if($("#pass").val().length < 8){
                e.preventDefault();
                //showValidate($("#pass"));
                //$("#pass").parent().attr("data-validate","Mot de passe doit avoir au minimum 8 caractere")
                swal("Oops!", "Mot de passe doit avoir au minimum 8 caractere", "warning");
                $("#passconfirm").val("")
                $("#pass").val("")
                check=false;
                ...
                swal("Oops!", "Mot de passe doit etre identique", "warning");
                $("#passconfirm").val("")
                $("#pass").val("")
                check=false;
            }
            ...
            if($("#email").val() != ""){
                if(checkEmail($("#email").val()) == "false"){
                    ...
                    swal("Oops!", "Adresse E-mail deja existante", "warning");
                    isValidEmail = false;
                }
            }
